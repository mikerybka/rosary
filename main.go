...
var joyfulMysteries = []Mystery{
	...
	},
	{
		...
		Text:       "Whem the days of her purification were fulfilled according to the Law of Moses, they took him up to Jerusalem to present him to the Lord.",
	},
	{
		Name:       "The Fifth Joyful Mystery: Finding the Child Jesus in the Temple",
		Verse:      "Luke 2:46",
		Dedication: "For the virtue of piety",
		Text:       "After three days, they found him in the temple, sitting in the midst of the teachers, listening to them and asking them questions.",
	},
}
var luminouslMysteries = []Mystery{
	...
	},
	{
		...
		Text:       "Jesus came in to Galilee, preaching the gospel of the kingdom of God, \"The time is fulfilled, and the kingdom of God is at hand. Repent and believe in the gospel.\"",
	},
	{
	...
	},
	{
		...
		Text:       "Having taken bread, he gave thanks and broke, and gave it to them, saying, \"This is my body, which is being given for you; do this in rememberance of me.\"",
	},
}
